	...
	constructor(scene: GameScene, x: number, y: number) {
		...
		this.restrictedItems = [
			...
			},
			{
				...
				sideEffect: [null,() => this.queueByPrerequisites(6,["Cherry Bomb","Apple Devourer","Bone Cruncher","Iron Roots"]),null,null,() => this.queueByPrerequisites(5,["Cherry Bomb","Cat's Riddle","Apple Devourer","Bone Cruncher","Prosperous Roots","Great Stone Splitter"])],
			},
			{
				type: ItemType.ChainUpgrade,
